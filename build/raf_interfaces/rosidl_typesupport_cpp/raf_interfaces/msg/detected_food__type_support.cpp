...
static const _DetectedFood_type_support_symbol_names_t _DetectedFood_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raf_interfaces, msg, DetectedFood)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, raf_interfaces, msg, DetectedFood)),
  }
};
...
{
  return &::raf_interfaces::msg::rosidl_typesupport_cpp::DetectedFood_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, raf_interfaces, msg, DetectedFood)() {
  return get_message_type_support_handle<raf_interfaces::msg::DetectedFood>();
}
