...
// IWYU pragma: private, include "raf_interfaces/srv/set_joint_angles.h"


#ifndef RAF_INTERFACES__SRV__DETAIL__SET_JOINT_ANGLES__FUNCTIONS_H_
#define RAF_INTERFACES__SRV__DETAIL__SET_JOINT_ANGLES__FUNCTIONS_H_
...
/// Initialize srv/SetJointAngles message.
/**
 ...
 * )) before or use
 * raf_interfaces__srv__SetJointAngles_Request__create()
...
/// Finalize srv/SetJointAngles message.
/**
...
/// Create srv/SetJointAngles message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * raf_interfaces__srv__SetJointAngles_Request__init().
...
/// Destroy srv/SetJointAngles message.
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Request__fini()
...
/// Check for srv/SetJointAngles message equality.
/**
...
/// Copy a srv/SetJointAngles message.
/**
...
/// Initialize array of srv/SetJointAngles messages.
/**
...
/// Finalize array of srv/SetJointAngles messages.
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Request__fini()
...
/// Create array of srv/SetJointAngles messages.
/**
 * It allocates the memory for the array and calls
 * raf_interfaces__srv__SetJointAngles_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetJointAngles messages.
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetJointAngles message array equality.
/**
...
/// Copy an array of srv/SetJointAngles messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * raf_interfaces__srv__SetJointAngles_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * raf_interfaces__srv__SetJointAngles_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
...
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
...
/**
 * It allocates the memory for the array and calls
 * raf_interfaces__srv__SetJointAngles_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
...
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * raf_interfaces__srv__SetJointAngles_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * raf_interfaces__srv__SetJointAngles_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
...
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
...
/**
 * It allocates the memory for the array and calls
 * raf_interfaces__srv__SetJointAngles_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_raf_interfaces
...
/**
 * It calls
 * raf_interfaces__srv__SetJointAngles_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RAF_INTERFACES__SRV__DETAIL__SET_JOINT_ANGLES__FUNCTIONS_H_
