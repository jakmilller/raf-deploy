...
raf_interfaces__srv__IdentifyFood_Request__init(raf_interfaces__srv__IdentifyFood_Request * msg)
{
  ...
  if (!sensor_msgs__msg__Image__init(&msg->frame)) {
    raf_interfaces__srv__IdentifyFood_Request__fini(msg);
    return false;
  }
  return true;
}
...
raf_interfaces__srv__IdentifyFood_Request__create(void)
{
  ...
  raf_interfaces__srv__IdentifyFood_Request * msg = (raf_interfaces__srv__IdentifyFood_Request *)allocator.allocate(sizeof(raf_interfaces__srv__IdentifyFood_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(raf_interfaces__srv__IdentifyFood_Request));
  bool success = raf_interfaces__srv__IdentifyFood_Request__init(msg);
  if (!success) {
...
raf_interfaces__srv__IdentifyFood_Request__Sequence__init(raf_interfaces__srv__IdentifyFood_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Request * data = NULL;

  if (size) {
    data = (raf_interfaces__srv__IdentifyFood_Request *)allocator.zero_allocate(size, sizeof(raf_interfaces__srv__IdentifyFood_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = raf_interfaces__srv__IdentifyFood_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        raf_interfaces__srv__IdentifyFood_Request__fini(&data[i - 1]);
      }
...
raf_interfaces__srv__IdentifyFood_Request__Sequence__fini(raf_interfaces__srv__IdentifyFood_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      raf_interfaces__srv__IdentifyFood_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Request__Sequence * array = (raf_interfaces__srv__IdentifyFood_Request__Sequence *)allocator.allocate(sizeof(raf_interfaces__srv__IdentifyFood_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = raf_interfaces__srv__IdentifyFood_Request__Sequence__init(array, size);
  if (!success) {
...
raf_interfaces__srv__IdentifyFood_Request__Sequence__destroy(raf_interfaces__srv__IdentifyFood_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    raf_interfaces__srv__IdentifyFood_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
raf_interfaces__srv__IdentifyFood_Request__Sequence__are_equal(const raf_interfaces__srv__IdentifyFood_Request__Sequence * lhs, const raf_interfaces__srv__IdentifyFood_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!raf_interfaces__srv__IdentifyFood_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  raf_interfaces__srv__IdentifyFood_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(raf_interfaces__srv__IdentifyFood_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    raf_interfaces__srv__IdentifyFood_Request * data =
      (raf_interfaces__srv__IdentifyFood_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raf_interfaces__srv__IdentifyFood_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raf_interfaces__srv__IdentifyFood_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!raf_interfaces__srv__IdentifyFood_Request__copy(
...
raf_interfaces__srv__IdentifyFood_Response__init(raf_interfaces__srv__IdentifyFood_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->food_items)) {
    raf_interfaces__srv__IdentifyFood_Response__fini(msg);
    return false;
  }
  // success
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Response * msg = (raf_interfaces__srv__IdentifyFood_Response *)allocator.allocate(sizeof(raf_interfaces__srv__IdentifyFood_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(raf_interfaces__srv__IdentifyFood_Response));
  bool success = raf_interfaces__srv__IdentifyFood_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
raf_interfaces__srv__IdentifyFood_Response__Sequence__init(raf_interfaces__srv__IdentifyFood_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Response * data = NULL;

  if (size) {
    data = (raf_interfaces__srv__IdentifyFood_Response *)allocator.zero_allocate(size, sizeof(raf_interfaces__srv__IdentifyFood_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = raf_interfaces__srv__IdentifyFood_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        raf_interfaces__srv__IdentifyFood_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
raf_interfaces__srv__IdentifyFood_Response__Sequence__fini(raf_interfaces__srv__IdentifyFood_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      raf_interfaces__srv__IdentifyFood_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Response__Sequence * array = (raf_interfaces__srv__IdentifyFood_Response__Sequence *)allocator.allocate(sizeof(raf_interfaces__srv__IdentifyFood_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = raf_interfaces__srv__IdentifyFood_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
raf_interfaces__srv__IdentifyFood_Response__Sequence__destroy(raf_interfaces__srv__IdentifyFood_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    raf_interfaces__srv__IdentifyFood_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
raf_interfaces__srv__IdentifyFood_Response__Sequence__are_equal(const raf_interfaces__srv__IdentifyFood_Response__Sequence * lhs, const raf_interfaces__srv__IdentifyFood_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!raf_interfaces__srv__IdentifyFood_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  raf_interfaces__srv__IdentifyFood_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(raf_interfaces__srv__IdentifyFood_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    raf_interfaces__srv__IdentifyFood_Response * data =
      (raf_interfaces__srv__IdentifyFood_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raf_interfaces__srv__IdentifyFood_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raf_interfaces__srv__IdentifyFood_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!raf_interfaces__srv__IdentifyFood_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
raf_interfaces__srv__IdentifyFood_Event__init(raf_interfaces__srv__IdentifyFood_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    raf_interfaces__srv__IdentifyFood_Event__fini(msg);
    return false;
  }
  // request
  if (!raf_interfaces__srv__IdentifyFood_Request__Sequence__init(&msg->request, 0)) {
    raf_interfaces__srv__IdentifyFood_Event__fini(msg);
    return false;
  }
  // response
  if (!raf_interfaces__srv__IdentifyFood_Response__Sequence__init(&msg->response, 0)) {
    raf_interfaces__srv__IdentifyFood_Event__fini(msg);
    return false;
  }
  return true;
...
raf_interfaces__srv__IdentifyFood_Event__fini(raf_interfaces__srv__IdentifyFood_Event * msg)
{
  ...
  // request
  raf_interfaces__srv__IdentifyFood_Request__Sequence__fini(&msg->request);
  // response
  raf_interfaces__srv__IdentifyFood_Response__Sequence__fini(&msg->response);
}
...
raf_interfaces__srv__IdentifyFood_Event__are_equal(const raf_interfaces__srv__IdentifyFood_Event * lhs, const raf_interfaces__srv__IdentifyFood_Event * rhs)
{
  ...
  // request
  if (!raf_interfaces__srv__IdentifyFood_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!raf_interfaces__srv__IdentifyFood_Response__Sequence__are_equal(
  ...
  raf_interfaces__srv__IdentifyFood_Event * output)
{
  ...
  // request
  if (!raf_interfaces__srv__IdentifyFood_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!raf_interfaces__srv__IdentifyFood_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Event * msg = (raf_interfaces__srv__IdentifyFood_Event *)allocator.allocate(sizeof(raf_interfaces__srv__IdentifyFood_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(raf_interfaces__srv__IdentifyFood_Event));
  bool success = raf_interfaces__srv__IdentifyFood_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
raf_interfaces__srv__IdentifyFood_Event__Sequence__init(raf_interfaces__srv__IdentifyFood_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Event * data = NULL;

  if (size) {
    data = (raf_interfaces__srv__IdentifyFood_Event *)allocator.zero_allocate(size, sizeof(raf_interfaces__srv__IdentifyFood_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = raf_interfaces__srv__IdentifyFood_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        raf_interfaces__srv__IdentifyFood_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
raf_interfaces__srv__IdentifyFood_Event__Sequence__fini(raf_interfaces__srv__IdentifyFood_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      raf_interfaces__srv__IdentifyFood_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raf_interfaces__srv__IdentifyFood_Event__Sequence * array = (raf_interfaces__srv__IdentifyFood_Event__Sequence *)allocator.allocate(sizeof(raf_interfaces__srv__IdentifyFood_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = raf_interfaces__srv__IdentifyFood_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
raf_interfaces__srv__IdentifyFood_Event__Sequence__destroy(raf_interfaces__srv__IdentifyFood_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    raf_interfaces__srv__IdentifyFood_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
raf_interfaces__srv__IdentifyFood_Event__Sequence__are_equal(const raf_interfaces__srv__IdentifyFood_Event__Sequence * lhs, const raf_interfaces__srv__IdentifyFood_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!raf_interfaces__srv__IdentifyFood_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  raf_interfaces__srv__IdentifyFood_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(raf_interfaces__srv__IdentifyFood_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    raf_interfaces__srv__IdentifyFood_Event * data =
      (raf_interfaces__srv__IdentifyFood_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raf_interfaces__srv__IdentifyFood_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raf_interfaces__srv__IdentifyFood_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!raf_interfaces__srv__IdentifyFood_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
